...
restricted = full.loc[full['dis_mpc'] <= 1000]
...
def biggraph():
    ...
    label0 = r'Redshift Independant Distance $without$ $\alpha$ and $\beta$ error' 
    label1 = r'Redshift Independant Distance $with$ $\alpha$ and $\beta$ error'
